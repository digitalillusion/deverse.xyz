              ...
              <div className="field">
                ...
                {isSubmitted === -1 && (
                  <span className="color-error">
                    <FormattedMessage id={"index_contact_fail"} />
                  </span>
                )}
                {isSubmitted === -2 && (
                  <span className="color-error">
                    <FormattedMessage id={"index_contact_fail_cookiepolicy"} />
                  </span>
                )}
              </div>
